...
keyboard = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(text="• مسح", callback_data="cls"),
            ]
        ]
    )
